...
export default function DashboardAppPage() {
  ...
  useEffect(() => {
    const getData = async () => {
      let initialValue = userData.data.position !== "3" && curentWarehouse === "Todos"
    ...
    <>
      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={2}>
          ...
          {userData.data.position !== "3" && < Grid item md={2}>
            <AppWidgetSummary title="Armazéns" total={userData.data.position !== "3" ? dashboard.warehouse : userData.data.warehouse.length} color="info" icon={'ant-design:apple-filled'} />
          </Grid>}
          ...
          <Grid item md={3}>
            <AppWidgetSummary title="Peças" total={dashboard.piece ?? 0} color="error" icon={'ant-design:bug-filled'} />
          </Grid>
          <Grid item md={3}>
